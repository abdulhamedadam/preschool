        ...
        @if(count($this->filteredStudents) > 0)
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400">
                    {{ count($this->filteredStudents) }} {{ __('common.students found') }}
                </div>
            </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center">
                                            ...
                                            <div class="ml-4 text-left">
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400">{{ @$student->guardian->name }}</div>
                                            </div>
                                        </div>
                                    </td>
            ...
            <div class="flex items-center justify-between gap-x-3">
                <div class="text-sm text-gray-500 dark:text-gray-400">
                    @php
                        ...
                        $absentCount = count($this->filteredStudents) - $presentCount;
                    @endphp
